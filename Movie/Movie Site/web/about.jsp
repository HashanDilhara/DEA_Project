...
<div class="swiper-container" style="background-color: var(--theme-bg);">
	...
	<div class="swiper-wrapper">
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/hashan.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-1">Hashan<br></h3>
				<div class="p-sm">
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/chanudi.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-2">Chanudi<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/geema.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-2">Ludmi<br></h3>
				<div class="p-sm">
						<a href="#"><i class="fa fa-linkedin"></i></a>
						<a href="#"><i class="fa fa-instagram"></i></a>
						<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
					<img src="assets/images/ramesh.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
					<h3 id="details-h3-2">Ramesh<br></h3>
					<div class="p-sm">
							<a href="#"><i class="fa fa-linkedin"></i></a>
							<a href="#"><i class="fa fa-instagram"></i></a>
							<a href="#"><i class="fa fa-github"></i></a>
                ...
                <div class="swiper-slide">
			<div class="imgBx">
					<img src="assets/images/hiruni.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
					<h3 id="details-h3-2">Hiruni<br></h3>
					<div class="p-sm">
							<a href="#"><i class="fa fa-linkedin"></i></a>
							<a href="#"><i class="fa fa-instagram"></i></a>
							<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/kavindu.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-4">Supem<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/sankalpa.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-4">Sankalpa<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
		...
		<div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/rashmika.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-4">Rashmika<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
                ...
                <div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/chiran.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-4">Theekshana<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
                ...
                <div class="swiper-slide">
			<div class="imgBx">
				<img src="assets/images/sanithi.jpg" style="width :100%; height: 100%">
			</div>
			<div class="details">
				<h3 id="details-h3-4">Sanithi<br></h3>
				<div class="p-sm">
					<a href="#"><i class="fa fa-linkedin"></i></a>
					<a href="#"><i class="fa fa-instagram"></i></a>
					<a href="#"><i class="fa fa-github"></i></a>
				...
				<div class="owl-clients owl-carousel owl-theme mb-lg-5">
					<div class="item">
						<div class="testimonial-content">
							<div class="testimonial">
								<blockquote>
									<q>Pain itself, sit down with honor. Blessed praise desires pleasure, and some pain endures.</q>
								</blockquote>
								<div class="testi-des">
					...
					<div class="item">
						<div class="testimonial-content">
							<div class="testimonial">
								<blockquote>
									<q>Pain itself, sit down with honor. Blessed praise desires pleasure, and some pain endures
								<div class="testi-des">
									<div class="test-img"><img src="assets/images/team3.jpg" class="img-fluid" alt="/">
									</div>
									<div class="peopl align-self">
